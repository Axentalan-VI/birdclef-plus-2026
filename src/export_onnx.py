...
def _safe_onnx_export(model, dummy, out_path, *, input_names, output_names, dynamic_axes, opset):
    """torch.onnx.export with dynamo disabled (avoids onnxscript dependency)."""
    try:
        torch.onnx.export(
